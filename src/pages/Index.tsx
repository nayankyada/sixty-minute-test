...
const Index = () => {
  ...
  const { timeRemaining, isTimeUp, formatTime, startTimer, resetTimer } =
        ...
        {isTimeUp && (
          <Alert className="mb-6 border-destructive bg-destructive/10">
            ...
            <AlertDescription className="text-destructive font-medium">
              Time's up! The 60-minute test period has ended. Please stop coding
            ...
            <Card className="max-w-2xl">
              <CardHeader className="text-center">
                <CardTitle className="text-2xl">
                  Ready to Start Your 60-Minute Test?
                </CardTitle>
                <CardDescription className="text-lg">
                  Once you click "Start Test", the timer will begin and you'll
                  have exactly 60 minutes to complete the task management
                  application.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="bg-muted/50 p-4 rounded-lg">
                  ...
                  <ul className="text-sm space-y-1 text-muted-foreground">
                    <li>
                      • TaskCard component with proper TypeScript interfaces
                    </li>
                    ...
                    <li>
                      • One advanced feature (search, sort, or drag & drop)
                    </li>
                  </ul>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2">
                <div className="space-y-6">
                    ...
                    <Card>
                      ...
                      <CardContent>
                        ...
                        <p className="text-sm mt-2 text-muted-foreground">
                          Form should include: title, description, priority, due
                          date
                        </p>
                      </CardContent>
                    </Card>
                  ...
                  {/* Task List Area */}
                  <TaskList tasks={tasks} priority={priority} setPriority={setPriority} setTasks={setTasks} />
                </div>
              </div>
            </div>
                ...
                <CardContent className="pt-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Validated form with error handling
                      </p>
                    </div>
                  </div>
                  <div className="mt-4 p-4 bg-primary/10 rounded-lg">
                    <p className="text-sm">
                      <strong>💡 Pro tip:</strong> Focus on functionality first,
                      then polish the styling. Use the design system tokens
                      (priority.high, priority.medium, priority.low) for
                      consistent colors.
                    </p>
                  </div>
                </CardContent>
